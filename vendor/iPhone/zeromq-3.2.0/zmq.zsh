...
export CXXFLAGS="-O -isysroot $SDK_ROOT/SDKs/iPhoneOS5.1.sdk"
export CC="${SDK_ROOT}/usr/bin/arm-apple-darwin10-llvm-gcc-4.2"
export CFLAGS="-O -isysroot $SDK_ROOT/SDKs/iPhoneOS5.1.sdk"
export AR=$SDK_ROOT"/usr/bin/ar"
export AS=$SDK_ROOT"/usr/bin/as"
export LD=$SDK_ROOT"/usr/bin/ld"
export LDFLAGS="-lstdc++ -isysroot $SDK_ROOT/SDKs/iPhoneOS5.1.sdk"
...
./configure --enable-static --host=arm-apple-darwin10 --prefix=$BUILD_DIR &>>| $ZMQ_BUILD_LOG_FILE
